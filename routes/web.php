...
Route::get('/', [App\Http\Controllers\HomeController::class, 'showFrontPage'])->name('front_page.index');
...
Route::resource('restaurants', App\Http\Controllers\RestaurantController::class)->middleware('Auth');
